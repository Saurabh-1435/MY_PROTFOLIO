  ...
  const education = [
    {
      ...
      period: "2021–2024",
      description: "Focused on full-stack development, DSA, and software architecture. Built real-world applications and participated in coding contests.",
      icon: "🎓"
    },
    {
    ...
    },
    {
      ...
      period: "2024",
      description: "Covered React, Spring Boot, Git, testing, and deployment workflows.",
      icon: "💻"
    }
  ];
          ...
          <div className="space-y-12">
            {education.map((item, index) => (
              <div key={item.title} className="relative flex items-start space-x-8">
                ...
                {/* Content */}
                <div className="glassmorphism p-6 rounded-lg hover-glow flex-1 group" style={{animationDelay: `${index * 0.2}s`}}>
